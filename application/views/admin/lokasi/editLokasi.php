                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="" method="post" <?php echo form_open_multipart('search/post_func');?><br>
                                <input type="hidden" name="id" value="<?= $lokasi['idBencana'];?>">
                                <div class="form-group row mb-4">
                                    ...
                                    <select name="id_bencana" class="form-control select2">
                                        <?php foreach($bencana as $a) : ?>
											<?php if($a['id_bencana'] == $lokasi['id_bencana']):?>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" name="tahunBencana"
                                            value="<?php echo $lokasi['tahunBencana'];?>">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" name="keteranganBencana"
                                            value="<?php echo $lokasi['keteranganBencana'];?>">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" name="lokasiBencana"
                                            value="<?php echo $lokasi['lokasiBencana'];?>">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        <input type="text" class="form-control" name="latitudeBencana" id="latitudeBencana"
                                            value="<?php echo $lokasi['latitudeBencana'];?>" readonly>
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        <input type="text" class="form-control" name="longitudeBencana" id="longitudeBencana"
                                            value="<?php echo $lokasi['longitudeBencana'];?>" readonly>
...
<script>
   ...
   $(document).ready(function() {
    ...
    $.getJSON('https://raw.githubusercontent.com/mtegarsantosa/json-nama-daerah-indonesia/master/regions.json', function(data) {
        ...
        // Mengambil data provinsi dan kota dari controller
        var selectedProvinsi = '<?php echo $lokasi['provinsiBencana']; ?>';
       var selectedKota = '<?php echo $lokasi["kotaBencana"]; ?>';


        // Mengatur opsi terpilih pada Provinsi
        if (selectedProvinsi !== '') {
        ...
        // Mengatur opsi terpilih pada Kota
        if (selectedKota !== '') {
...
<script>
    ...
    // Ambil data longitude dan latitude dari PHP (misalnya, dalam variabel $longitudeBencana dan $latitudeBencana)
    var longitudeBencana = <?php echo $lokasi['longitudeBencana']; ?>;
    var latitudeBencana = <?php echo $lokasi['latitudeBencana']; ?>;

    // Tambahkan marker ke peta dengan menggunakan data longitude dan latitude
    if (longitudeBencana && latitudeBencana) {
        var markerLatLng = [latitudeBencana, longitudeBencana];
        marker = L.marker(markerLatLng).addTo(map);
        map.setView(markerLatLng, 12); // Atur tampilan peta ke marker

        document.getElementById('latitudeBencana').value = latitudeBencana;
        document.getElementById('longitudeBencana').value = longitudeBencana;
    }
</script>
