                        ...
                        <div class="card-body">
                            <form action="" method="post" <?php echo form_open_multipart('search/post_func');?><br>
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Topik Quiz</label>
                                ...
                                <!-- <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Durasi Quiz</label>
                                    <div class="col-sm-12 col-md-7">
                                        <input type="number" class="form-control" name="durasi_pg" placeholder="Masukan Durasi Quiz dengan angka dalam hitungan menit"
                                            value="<?= set_value('durasi_pg'); ?>">
