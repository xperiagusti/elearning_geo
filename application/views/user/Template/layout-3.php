  ...
  <div id="app">
    <div class="main-wrapper container">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        <a href="<?php echo base_url(); ?>user" class="navbar-brand sidebar-gone-hide">DISASTER.CO</a>
        ...
        <!-- <div class="nav-collapse">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item"><a href="#" class="nav-link">E-Knowledge</a></li>
          </ul>
        </div> -->
        <form class="form-inline ml-auto" method="POST" action="<?php echo base_url('user/search');?>">
          <ul class="navbar-nav">
            <li><a href="#" data-toggle="search" class="nav-link nav-link-lg d-sm-none"><i class="fas fa-search"></i></a></li>
          </ul>
          <div class="search-element">
            <input class="form-control" type="search" placeholder="Cari Topik E-Knowledge" name="keyword" aria-label="Search" data-width="250">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="<?php echo base_url(); ?>admin" class="dropdown-item has-icon">
                <i class="fas fa-bolt"></i> Halaman Admin
              </a>
              <?php endif; ?>
