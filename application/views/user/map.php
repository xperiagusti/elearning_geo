    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 text-center">
                <h2 class="mb-4">Browse E-Knowledge</h1>
            </div>
...
<section class="contact-section section-padding section-bg" id="section_5">
    ...
    z-index: 1;height: 250px; width: 100%;"></div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-2">
                            <select class="form-control" id="selectProvinsi">
                                ...
                                <?php foreach ($lokasi as $a): ?>
                                            <option value="<?= $a["provinsiBencana"] ?>"><?= $a["provinsiBencana"] ?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
                        <div class="col-md-4 mb-2">
                        ...
                        <div class="col-md-4 mb-2">
                            <button type="button" class="btn btn-primary" onclick="filterMarkers()">Filter</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        var marker = L.marker([markerData.latitude, markerData.longitude], { icon: customIcon })
            .addTo(map)
            .bindPopup(
                "Nama Bencana: " + markerData.nama +
                "<br>Tahun Bencana: " + markerData.tahun +
                "<br>Bulan Bencana: " + markerData.bulan +
                "<br>Provinsi Bencana: " + markerData.provinsi +
                "<br>Kota Bencana: " + markerData.kota +
                "<br>Keterangan Bencana: " + markerData.keterangan
            );
